...
The canonical feature authority influences the file-body projection **indirectly first, then directly through an expectation-derived body contract**.

It must not jump straight from feature JSON to handwritten TypeScript syntax.
